...
namespace Base.DataAccess.Repository
{
    ...
    public interface IRepository<T> where T : new()
    {
        ...
        /// <returns></returns>
        List<T> FindListPage(ref PageParam jqgridparam);
        /// <summary>
        /// 查询数据列表、返回List
        /// </summary>
        /// <param name="WhereSql">条件</param>
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        List<T> FindListPage(string WhereSql, ref PageParam jqgridparam);
        /// <summary>
        /// 查询数据列表、返回List
        /// </summary>
        /// <param name="WhereSql">条件</param>
        ...
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        List<T> FindListPage(string WhereSql, DbParameter[] parameters, ref PageParam jqgridparam);
        /// <summary>
        /// 查询数据列表、返回List
        /// </summary>
        /// <param name="strSql">Sql语句</param>
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        List<T> FindListPageBySql(string strSql, ref PageParam jqgridparam);
        /// <summary>
        /// 查询数据列表、返回List
        /// </summary>
        /// <param name="strSql">Sql语句</param>
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        List<T> FindListPageBySql(string strSql, DbParameter[] parameters, ref PageParam jqgridparam);
        #endregion
        ...
        /// <returns></returns>
        DataTable FindTablePage(ref PageParam jqgridparam);
        /// <summary>
        /// 查询数据列表、返回 DataTable
        /// </summary>
        /// <param name="WhereSql">条件</param>
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        DataTable FindTablePage(string WhereSql, ref PageParam jqgridparam);
        /// <summary>
        /// 查询数据列表、返回 DataTable
        /// </summary>
        /// <param name="WhereSql">条件</param>
        ...
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        DataTable FindTablePage(string WhereSql, DbParameter[] parameters, ref PageParam jqgridparam);
        /// <summary>
        /// 查询数据列表、返回 DataTable
        /// </summary>
        /// <param name="strSql">Sql语句</param>
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        DataTable FindTablePageBySql(string strSql, ref PageParam jqgridparam);
        /// <summary>
        /// 查询数据列表、返回 DataTable
        /// </summary>
        /// <param name="strSql">Sql语句</param>
        ...
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        DataTable FindTablePageBySql(string strSql, DbParameter[] parameters, ref PageParam jqgridparam);
        /// <summary>
        /// 查询数据列表、返回 DataTable
        /// </summary>
        /// <param name="procName">存储过程</param>
