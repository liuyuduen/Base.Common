...
namespace Base.DataAccess.Repository
{
    ...
    public class Repository<T> : IRepository<T> where T : new()
    {
        ...
        {
            return DataFactory.Database().Update(SQL);
        }
        /// <summary>
        /// 修改数据
        /// </summary>
        ...
        /// <returns></returns>
        public List<T> FindListPage(ref PageParam jqgridparam)
        {
        ...
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        public List<T> FindListPage(string WhereSql, ref PageParam jqgridparam)
        {
            string orderField = jqgridparam.sidx;
            string orderType = jqgridparam.sord;
            int pageIndex = jqgridparam.page;
        ...
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        public List<T> FindListPage(string WhereSql, DbParameter[] parameters, ref PageParam jqgridparam)
        {
            string orderField = jqgridparam.sidx;
            string orderType = jqgridparam.sord;
            int pageIndex = jqgridparam.page;
        ...
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        public List<T> FindListPageBySql(string strSql, ref PageParam jqgridparam)
        {
            string orderField = jqgridparam.sidx;
            string orderType = jqgridparam.sord;
            int pageIndex = jqgridparam.page;
        ...
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        public List<T> FindListPageBySql(string strSql, DbParameter[] parameters, ref PageParam jqgridparam)
        {
            string orderField = jqgridparam.sidx;
            string orderType = jqgridparam.sord;
            int pageIndex = jqgridparam.page;
        ...
        /// <returns></returns>
        public DataTable FindTablePage(ref PageParam jqgridparam)
        {
            string orderField = jqgridparam.sidx;
            string orderType = jqgridparam.sord;
            int pageIndex = jqgridparam.page;
        ...
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        public DataTable FindTablePage(string WhereSql, ref PageParam jqgridparam)
        {
            string orderField = jqgridparam.sidx;
            string orderType = jqgridparam.sord;
            int pageIndex = jqgridparam.page;
        ...
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        public DataTable FindTablePage(string WhereSql, DbParameter[] parameters, ref PageParam jqgridparam)
        {
            string orderField = jqgridparam.sidx;
            string orderType = jqgridparam.sord;
            int pageIndex = jqgridparam.page;
        ...
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        public DataTable FindTablePageBySql(string strSql, ref PageParam jqgridparam)
        {
            string orderField = jqgridparam.sidx;
            string orderType = jqgridparam.sord;
            int pageIndex = jqgridparam.page;
        ...
        /// <param name="jqgridparam">分页参数</param>
        /// <returns></returns>
        public DataTable FindTablePageBySql(string strSql, DbParameter[] parameters, ref PageParam jqgridparam)
        {
            string orderField = jqgridparam.sidx;
            string orderType = jqgridparam.sord;
            int pageIndex = jqgridparam.page;
